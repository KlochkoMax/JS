...
/*
    ...
    // ];
        ...
        //     document.write(`<div><h3>${simpson.name} ${simpson.surname}</h3> <b>age is - ${simpson.age}</b>
        //                     <br> ${simpson.info}<br>
        //                      <img src="${simpson.photo}" alt="photo"></div>`
        //     )
        //
        // }
        //
        ...
        //Template2.2
        // document.write(`<div class="bod">`)
        // for (let i = 0; i < simpsons.length; i++) {
        //     let simpson = simpsons[i];
        //     document.write(`<div class="cont"><h2>${simpson.name} ${simpson.surname} age is - ${simpson.age}</h2><br>
        //                      <p>${simpson.info}</p><br>
...
/*
        ...
        //     },
        // ];
        // document.write(`<div class="product_main">`)
